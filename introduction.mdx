...
Atomix QRGen is a modern, privacy-focused QR code generator built with Astro, Preact, and Tailwind CSS. Generate customizable QR codes for multiple formats including URLs, WiFi credentials, vCards, calendar events, payment information, and plain text — all fully client-side.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="qrcode"
  >
    Support for URL, Text, WiFi, vCard, Event, and Payment QR codes with format-specific validation
  </Card>
  <Card
    title="Privacy-first"
    icon="shield-check"
